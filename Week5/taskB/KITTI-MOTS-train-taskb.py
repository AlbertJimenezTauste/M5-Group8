...
for model_name in models: 
    ...
    if first:
        ...
        DatasetCatalog.register("MOTSChallenge_" + d, 
            lambda d=d: get_KITTI_MOTS_dicts("/home/mcv/datasets/MOTSChallenge/train/images/", train_seqmap_mots, path = path))
    ...
    cfg.DATASETS.TRAIN = ("KITTI_MOTS_train","MOTSChallenge_train",)
