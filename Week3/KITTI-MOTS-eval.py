...
def get_KITTI_MOTS_test_dicts(img_dir, seqmap):
...
d = "test"
DatasetCatalog.register("KITTI_MOTS_" + d, 
    lambda d=d: get_KITTI_MOTS_test_dicts("/home/mcv/datasets/KITTI-MOTS/testing/image_02/", seqmap_test))
MetadataCatalog.get("KITTI_MOTS_" + d).set(thing_classes=class_list)
...
dataset_dicts = get_KITTI_MOTS_dicts("/home/mcv/datasets/KITTI-MOTS/training/image_02/", seqmap_train)
ide = 0
...
dataset_dicts = get_KITTI_MOTS_test_dicts("/home/mcv/datasets/KITTI-MOTS/testing/image_02/", seqmap_test)
ide = 0
for d in dataset_dicts:
    ...
    cv2.imwrite("test/test"+str(ide)+".jpg", v.get_image()[:, :, ::-1])
    ide += 1
